...
public class Consumer {
    ...
    public static Options buildCommandlineOptions(final Options options) {
        ...
        opt = new Option("g", "group", true, "OrderConsumer group name, Default: benchmark_consumer");
        opt.setRequired(false);
        options.addOption(opt);

        opt = new Option("p", "group prefix enable", true, "OrderConsumer group name, Default: false");
        opt.setRequired(false);
        options.addOption(opt);
